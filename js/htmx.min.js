    ...
    return function() {
        ...
        function J(e, t, r) {
            ...
            if (o) {
                ...
                ot(P().body, "htmx:oobErrorNoTarget", {
                    content: t
                })
            }
            return e
        ...
        function Te(e) {
            return e.tagName === "FORM" || v(e, 'input[type="submit"], button') && O(e, "form") !== null || e.tagName === "A" && e.href && (e.getAttribute("href") === "#" || e.getAttribute("href").indexOf("#") !== 0)
        }
